...
Version 0.7.0 adds an imported Aether bench and procedural albedo to the native visual playground, with a validated offline cooker and dependency-free native asset reader. Headless builds remain independent of SDL and external ECS libraries.
